...
if (isset($_POST['message']) && isset($_POST['income_id']) && isset($_POST['outcome_id'])) {
    DB::query("INSERT INTO messages VALUES ('', :message, :income_id, :outcome_id);", array(':message' => htmlspecialchars($_POST['message']), ':income_id' => $_POST['income_id'], ':outcome_id' => $_POST['outcome_id']));
}
